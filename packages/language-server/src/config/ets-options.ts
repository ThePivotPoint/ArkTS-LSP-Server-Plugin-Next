...
export function getEtsOptions(): ets.EtsOptions {
  return {
    libs: [
      'c:\\Users\\Administrator\\AppData\\Local\\OpenHarmony\\Sdk\\11\\ets\\api\\@ohos.wifi.d.ts',
      'C:\\Users\\Administrator\\AppData\\Local\\OpenHarmony\\Sdk\\11\\ets\\kits\\@kit.NetworkKit.d.ts',
    ],
    syntaxComponents: {
      attrUICallback: [],
      paramsUICallback: [],
